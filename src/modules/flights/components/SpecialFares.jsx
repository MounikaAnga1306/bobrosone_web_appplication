...
const SpecialFares = ({ specialFares, setSpecialFares }) => {
  const fares = [
    { id: 'student', name: 'Student', discount: 'Upto 10% off' },
    { id: 'seniorCitizen', name: 'Senior Citizen', discount: 'Upto 15% off' },
    { id: 'armedForces', name: 'Armed Forces', discount: 'Special fares' }
  ];
  ...
  return (
    <div className="mt-4 pt-4 border-t border-gray-200">
      <h3 className="text-sm font-medium text-gray-700 mb-3">Special Fares (Optional):</h3>
